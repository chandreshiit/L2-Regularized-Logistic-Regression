function adadelta(train)
%  Solves L2 regularized logisitc regression using Adadelta
%  f(w) = 1/m {\sum_i log(1+exp(-y_iw'*x_i)) + \rho/2*\|w\|_2^2} (avg loss +
%  regularization term)
%  We solve the above problem using Adadelta algorithm by Matthew D. Zeiler
