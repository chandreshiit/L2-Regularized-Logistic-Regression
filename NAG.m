function NAG(train)
%  Solves L2 regularized logisitc regression via Nesterov's Accelerated
%  Gradient Method
...
%         evaluate the gradient at x(j,:)
        grad = eval_grad(w-momentum*deltaw,y(j),x(j,:)); % note the point at which gradient is evaluated
